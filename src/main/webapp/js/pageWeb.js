...
//	banner
	...
	var url1 = "json/homeBanner.action";
	
	$.get(url1,function(data){				
		//i 索引 n对象
		$(data).each(function(i,n){
			
			$(".banner .main-content .show div table").append("<tr><td>"+n.name+"</td><td><img src='"+n.src+"'/></td><td>"+n.url+"</td><td><a href=''><span class='table_edit'>编辑</span></a><a href='home/deleteBanner.action?imgid=" + n.id +"'><span class='table_delete'>删除</span></a></td></tr>");
		});
	});
	picload(".banner");
...
//dynamic
	var url = "json/instDynamic.action";
	
	$.get(url,function(data){				
		//i 索引 n对象
		$(data).each(function(i,n){
			
			$(".info .main-content .show div table").append("<tr><td>"+n.title+"</td><td>"+n.postTime+"</td><td><a href=''><span class='table_edit'>编辑</span></a><a href='instDynamic/deleteDynamic.action?instid=" + n.artId +"'><span class='table_delete'>删除</span></a></td></tr>");
		});
	});
