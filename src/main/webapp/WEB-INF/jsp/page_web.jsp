...
<body>
	...
	<div class="header">
		<div class="container">
			...
			<ul>
				<li><a href="page_first.html">
						<p>首页</p> <span></span>
				</a></li>
				<li><a href="page_web.html">
						<p>官网设置</p> <span></span>
				</a></li>
				<li><a href="page_forums.html">
						<p>论坛设置</p> <span></span>
				</a></li>
			</ul>
			<ol>
				...
				<li class="banner select">
					...
					<ul class="main-content">
						...
						<li class="hidden">
							<div>
								<form
									action="${pageContext.request.contextPath }/home/addBanner.action"
									...
									<div class="picload">
										<!--修改上传input样式 图片只读jpg、png、gif-->
										<input name="pictureFile" type="file" /> <input
											name="clickfile" type="button" value="选择文件" /> <span>未选择任何文件</span>
										<div></div>
									</div>
									<button class="submit">提交</button>
									<button class="cancel">取消</button>
								</form>
							</div> <img class="return_show" src="img/index/return_pic.jpg" alt="" />
						</li>
					</ul>
				</li>
				<li class="video">
							...
							<div>
								<table border="1" cellspacing="0" cellpadding="">
									...
									<tr>
										...
										<td>2018-03-07</td>
										<td><span class="table_edit">编辑</span> <span
											class="table_delete">删除</span></td>
									</tr>
									<tr>
										<td>快速提升UI能力</td>
										<td>UI设计</td>
						...
						<li class="hidden">
							<div>
								<ul class="content-list">
									<li>
										<h2>视频标题：</h2> <input type="text" name="#"
										placeholder="请输入视频标题" />
									</li>
									<li>
										<h2>视频类型：</h2> <input type="text" name="#"
										placeholder="请输入视频类型" />
									</li>
									<li>
										<h2>视频讲师：</h2> <input type="text" name="#"
										placeholder="请输入视频讲师" />
									</li>
									<li>
										<h2>视频连接：</h2> <input type="text" name="#"
										placeholder="请输入视频链接" />
									</li>
									<li>
										<h2>日期：</h2> <input type="text" name="#" placeholder="请输入日期" />
									</li>
									<li>
										<h2>目前更新：</h2> <input type="text" name="#" placeholder="请输入更新" />
									</li>
								</ul>
								<h2>是否首页推荐：</h2>
								<input type="radio" name="recommend" />是 <input type="radio"
									name="recommend" />否
								<h2>课程目录：</h2>
								<input type="text" name="#" placeholder="请输入标题" /> <span
									class="add-content"> <i>+</i> 可添加目录
								</span>
								<!--<h2>轮播标题：</h2>
								...
								<div class="picload">
									<!--修改上传input样式 图片只读jpg、png、gif-->
									<input type="file" name="#" /> <input type="button" name="#"
										value="选择文件" /> <span>未选择任何文件</span>
									<div></div>
								</div>
					...
					<ul class="main-content">
						<li class="show">
							<div>
								<table border="1" cellspacing="0" cellpadding="">
									...
									<tr>
										<td>1</td>
										<td><img src="img/index/fail_pic.jpg" /></td>
										<td><span class="table_edit">编辑</span> <span
											class="table_delete">删除</span></td>
									</tr>
									<tr>
						...
						<li class="hidden">
							<div class="picload">
								...
								<div>
									<!--修改上传input样式 图片只读jpg、png、gif-->
									<input type="file" /> <input type="button" value="选择文件" /> <span>未选择任何文件</span>
									<div></div>
								</div>
								<button class="submit">提交</button>
								<button class="cancel">取消</button>
